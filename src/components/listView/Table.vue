          ...
          <td class="hazard-table__detail-view detail-view" :colspan="headers.length ">
            <form class="form-detail-view">
              ...
              <div class="detail-view__groups">
                ...
                <div v-if="specification_customMadeDevice === 'Spezifikation'">
                  ...
                  <div v-if="postProcessingPossibility === 'yes'">
                    ...
                    <div class="button-container detail-view__button-container">
                      <router-link
                        ...
                        <button class="button button--cancel button--detail-view button--detail-view-cancel">Gefährdung erstellen</button>
                      </router-link>
                  ...
                  <div v-if="postProcessingPossibility === 'no'">
                    ...
                    <div class="button-container detail-view__button-container">
                      <button @click.prevent="showModal = true" class="button button--cancel button--detail-view button--detail-view-cancel">Herstellung abbrechen
                      </button>
                    </div>
                  </div>
                </div>
              ...
              <div class="detail-view__groups detail-view__groups--made-device"
                ...
                <div class="button-container detail-view__button-container">
                  <input @click="accept(item.id)" class="button button--submit button--detail-view button--detail-view-submit" type="submit"
  ...
  data() {
    return {
      ...
      hazardsHeader: [
        ...
        {text: 'Nicht zutreffend', value: 'nicht-zutreffend', sortable: false},
        {text: 'Akzeptiert', value: 'akzeptiert', sortable: false},
